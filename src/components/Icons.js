...
export const Linkedin = ({ className, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={`w-full h-auto ${className}`} {...rest} >
...
export const Twitter = ({ className, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 209" className={`w-full h-auto ${className}`} {...rest} >
...
export const Pinterest = ({ className, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={`w-full h-auto ${className}`} {...rest} >
        <path fill="rgba(255, 255, 255, 0)" d="M0 0h256v256H0z" />
        <path
            fill="#CB1F27"
...
export const Github = ({ className, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={`w-full h-auto ${className}`} {...rest}>
